...
> 也可以直接添加 `fnpack.json` 直链：
> `https://raw.githubusercontent.com/MisiteQ/FnDepot/main/fnpack.json`

## 📦 源内应用

| 应用 | 说明 | 架构 |
| --- | --- | --- |
| [飞牛监控 (fnMonitor)](./fnmonitor/README.md) | fnOS 系统监控面板：实时监控 CPU / 内存 / 磁盘 / 网络 / 温度 / 功耗 / GPU 与 Docker，支持流量统计、功耗统计、历史趋势与数据持久化 | x86 / arm |
