...
| [天气预报 (QWeather Widget)](https://github.com/MisiteQ/FnDepot/blob/main/com.qweather.widget/README.md) | 飞牛桌面天气预报小部件：直接注入飞牛桌面显示，支持实时天气、5 天预报、城市切换、拖动、透明度调节、调整大小，数据来源 Open-Meteo 无需 API Key | x86 |
